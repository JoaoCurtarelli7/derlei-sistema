    ...
    form
      ...
      .then((values) => {
        const formattedValues = {
          ...
          valorTotal: parseFloat(values.valorTotal.replace(/[^\d,]/g, '').replace(',', '.')),
          frete4: parseFloat(values.frete4.replace(/[^\d,]/g, '').replace(',', '.')),
          somaTotalFrete: parseFloat(values.somaTotalFrete.replace(/[^\d,]/g, '').replace(',', '.')),
          fechamentos: parseFloat(values.fechamentos.replace(/[^\d,]/g, '').replace(',', '.')),
        };
    ...
    >
      <Form form={form} layout="vertical">
        ...
        <Form.Item
          ...
          rules={[{ required: true, message: 'Por favor, insira o valor do frete 4%' }]}
        >
          <Input
            placeholder="R$ 0,00"
            onChange={(e) => {
        ...
        <Form.Item
          ...
          rules={[{ required: true, message: 'Por favor, insira a soma total do frete' }]}
        >
          <Input
            placeholder="R$ 0,00"
            onChange={(e) => {
        ...
        <Form.Item
          ...
          rules={[{ required: true, message: 'Por favor, insira o fechamento' }]}
        >
          <Input
            placeholder="R$ 0,00"
            onChange={(e) => {
